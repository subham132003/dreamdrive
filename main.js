...
function item1(a) {
    ...
    if (a != select2) {
        ...
        document.getElementById("price1").innerHTML = "We are Selling at INR " + product[a].price
...
function item2(a) {
    ...
    if (a != select1) {
        ...
        document.getElementById("price2").innerHTML = "We are selling at INR " + product[a].price
